...
const TypeOptions: FC<{ question: Question }> = ({ question }) => {
  if (question.type === QuestionTypes.SINGLECHOICE) {
    return <TypeOption question={question} label="Prepare options for users" />;
  }
  ...
  if (question.type === QuestionTypes.SCALE) {
